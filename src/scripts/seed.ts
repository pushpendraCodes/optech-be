...
async function seed() {
  ...
  const cms = [
    ...
    { kind: "ad" as const, title: "Refer a friend. Earn rewards.", body: "Enrolled students get a unique code. When a friend joins a paid course, you earn.", href: "/student/login", cta: "Student login", slot: "box1", sortOrder: 0 },
    { kind: "ad" as const, title: "PGDCA evening batch — seats open", body: "One-year professional track with placement cell support. Starts 15 Sep 2026.", href: "/courses/pgdca", cta: "View PGDCA", slot: "box1", sortOrder: 1 },
    { kind: "ad" as const, title: "Placement jobs this week", body: "Data entry, DTP, and computer operator roles matched to your course.", href: "/jobs", cta: "See listings", slot: "box1", sortOrder: 2 },
